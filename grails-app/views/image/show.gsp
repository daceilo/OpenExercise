	...
	<body>
		...
		<div id="show-image" class="content scaffold-show" role="main">
			...
			<ol class="property-list image">
				...
				<g:if test="${imageInstance?.size}">
				<li class="fieldcontain">
					<span id="size-label" class="property-label"><g:message code="image.size.label" default="Size" /></span>
					
						<span class="property-value" aria-labelledby="size-label"><g:fieldValue bean="${imageInstance}" field="size"/></span>
				...
				<g:if test="${imageInstance?.exercise}">
				<li class="fieldcontain">
					<span id="exercise-label" class="property-label"><g:message code="image.exercise.label" default="Exercise" /></span>
					
						<span class="property-value" aria-labelledby="exercise-label"><g:link controller="exercise" action="show" id="${imageInstance?.exercise?.id}">${imageInstance?.exercise?.encodeAsHTML()}</g:link></span>
